...
void DSMGA2::oneRun (bool output) {
    ...
    if (trace_process){cout << "########################## NEW ONERUN ###############################" << endl;}
    ...
    if (original_nCurrent >= 10)
    {
        ...
        //     cout << "Gen = " << generation << " 三群都有BB收斂到次佳解" << endl;
    ...
    for (int G = 0; G < 3; ++G) {
        ...
        //     if (conv0 && conv1 && conv2)
        //     {
        //         cout << "Gen = " << generation << " After BM 三群都有BB收斂到次佳解!!" << endl;
        //         // cout << "Here" << endl;
        //         // cout << "=======Pop G0========"<< endl;
        ...
        //         // }
        //     }else{
        //         cout << "Gen = " << generation << " After BM 三群沒有都有BB收斂到次佳解" << endl<<endl;
        //         if(conv0){
    ...
    for (int tt = 0; tt < nCurrent; ++tt) {
        population[tt] = temp_population[tt];
    }
